...
filen="processedData/gate0_numblock_%s_meff_%s_offsetn_%s_offsetm_%s_dynamic.npy" %(str(sizen),str(meff*2),str(offsetn),str(offsetm))
...
filen="processedData/gate0_numblock_%s_meff_%s_offsetn_%s_offsetm_%s_toep.npy" %(str(sizen),str(meff_f),str(offsetn),str(offsetm))
np.save(filen,comp)
