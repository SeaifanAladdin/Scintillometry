...
plt.imshow(np.log10(cj), aspect='auto',cmap=cm.Greys, interpolation='nearest', vmin=2, origin='lower')
#plt.pcolormesh(x_ds,y_ds,np.log10(cj),  cmap=cm.Greys)
##plt.imshow(np.log10(cj), aspect='auto', cmap=cm.Greys, interpolation='nearest',origin='lower')
plt.colorbar()
#plt.ylim(0, 128)
#plt.xlim(-25.4,25.4)
